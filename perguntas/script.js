...
function checked()
{
  ...
  sessionStorage.setItem("acertosInstacia", acertos); // Criando variavel de instância
	open('fim.html','fim','status=no,Width=730px,Height=600px'); // Abrindo pagina de qtt de resposta
